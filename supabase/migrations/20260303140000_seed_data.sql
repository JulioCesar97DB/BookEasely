-- BookEasely: Seed data for testing and demo
-- Wrapped in a migration to apply to remote via supabase db push
-- Idempotent: uses ON CONFLICT DO NOTHING and checks before insert
-- Disables notification triggers to avoid duplicate notifications
...
INSERT INTO auth.users (id, instance_id, email, encrypted_password, email_confirmed_at, raw_user_meta_data, role, aud, created_at, updated_at)
VALUES
  ('b0000000-0000-0000-0000-000000000001', '00000000-0000-0000-0000-000000000000', 'owner1@bookeasely.com', extensions.crypt('password123', extensions.gen_salt('bf')), now(), '{"full_name":"Maria Rodriguez","phone":"(555) 200-0001","role":"business_owner"}'::jsonb, 'authenticated', 'authenticated', now(), now()),
  ('b0000000-0000-0000-0000-000000000002', '00000000-0000-0000-0000-000000000000', 'owner2@bookeasely.com', extensions.crypt('password123', extensions.gen_salt('bf')), now(), '{"full_name":"James Chen","phone":"(555) 200-0002","role":"business_owner"}'::jsonb, 'authenticated', 'authenticated', now(), now()),
  ('b0000000-0000-0000-0000-000000000003', '00000000-0000-0000-0000-000000000000', 'owner3@bookeasely.com', extensions.crypt('password123', extensions.gen_salt('bf')), now(), '{"full_name":"Sarah Johnson","phone":"(555) 200-0003","role":"business_owner"}'::jsonb, 'authenticated', 'authenticated', now(), now()),
  ('b0000000-0000-0000-0000-000000000004', '00000000-0000-0000-0000-000000000000', 'owner4@bookeasely.com', extensions.crypt('password123', extensions.gen_salt('bf')), now(), '{"full_name":"David Kim","phone":"(555) 200-0004","role":"business_owner"}'::jsonb, 'authenticated', 'authenticated', now(), now())
ON CONFLICT (id) DO NOTHING;

-- Clients
INSERT INTO auth.users (id, instance_id, email, encrypted_password, email_confirmed_at, raw_user_meta_data, role, aud, created_at, updated_at)
VALUES
  ('c0000000-0000-0000-0000-000000000001', '00000000-0000-0000-0000-000000000000', 'client1@bookeasely.com', extensions.crypt('password123', extensions.gen_salt('bf')), now(), '{"full_name":"Alex Thompson","phone":"(555) 300-0001","role":"client"}'::jsonb, 'authenticated', 'authenticated', now(), now()),
  ('c0000000-0000-0000-0000-000000000002', '00000000-0000-0000-0000-000000000000', 'client2@bookeasely.com', extensions.crypt('password123', extensions.gen_salt('bf')), now(), '{"full_name":"Emma Wilson","phone":"(555) 300-0002","role":"client"}'::jsonb, 'authenticated', 'authenticated', now(), now()),
  ('c0000000-0000-0000-0000-000000000003', '00000000-0000-0000-0000-000000000000', 'client3@bookeasely.com', extensions.crypt('password123', extensions.gen_salt('bf')), now(), '{"full_name":"Michael Brown","phone":"(555) 300-0003","role":"client"}'::jsonb, 'authenticated', 'authenticated', now(), now()),
  ('c0000000-0000-0000-0000-000000000004', '00000000-0000-0000-0000-000000000000', 'client4@bookeasely.com', extensions.crypt('password123', extensions.gen_salt('bf')), now(), '{"full_name":"Sofia Garcia","phone":"(555) 300-0004","role":"client"}'::jsonb, 'authenticated', 'authenticated', now(), now()),
  ('c0000000-0000-0000-0000-000000000005', '00000000-0000-0000-0000-000000000000', 'client5@bookeasely.com', extensions.crypt('password123', extensions.gen_salt('bf')), now(), '{"full_name":"Ryan Davis","phone":"(555) 300-0005","role":"client"}'::jsonb, 'authenticated', 'authenticated', now(), now())
ON CONFLICT (id) DO NOTHING;

-- Workers
INSERT INTO auth.users (id, instance_id, email, encrypted_password, email_confirmed_at, raw_user_meta_data, role, aud, created_at, updated_at)
VALUES
  ('d0000000-0000-0000-0000-000000000001', '00000000-0000-0000-0000-000000000000', 'worker1@bookeasely.com', extensions.crypt('password123', extensions.gen_salt('bf')), now(), '{"full_name":"Carlos Mendez","phone":"(555) 400-0001","role":"worker"}'::jsonb, 'authenticated', 'authenticated', now(), now()),
  ('d0000000-0000-0000-0000-000000000002', '00000000-0000-0000-0000-000000000000', 'worker2@bookeasely.com', extensions.crypt('password123', extensions.gen_salt('bf')), now(), '{"full_name":"Lisa Park","phone":"(555) 400-0002","role":"worker"}'::jsonb, 'authenticated', 'authenticated', now(), now()),
  ('d0000000-0000-0000-0000-000000000003', '00000000-0000-0000-0000-000000000000', 'worker3@bookeasely.com', extensions.crypt('password123', extensions.gen_salt('bf')), now(), '{"full_name":"Ahmed Hassan","phone":"(555) 400-0003","role":"worker"}'::jsonb, 'authenticated', 'authenticated', now(), now()),
  ('d0000000-0000-0000-0000-000000000004', '00000000-0000-0000-0000-000000000000', 'worker4@bookeasely.com', extensions.crypt('password123', extensions.gen_salt('bf')), now(), '{"full_name":"Nina Patel","phone":"(555) 400-0004","role":"worker"}'::jsonb, 'authenticated', 'authenticated', now(), now()),
  ('d0000000-0000-0000-0000-000000000005', '00000000-0000-0000-0000-000000000000', 'worker5@bookeasely.com', extensions.crypt('password123', extensions.gen_salt('bf')), now(), '{"full_name":"Jake Williams","phone":"(555) 400-0005","role":"worker"}'::jsonb, 'authenticated', 'authenticated', now(), now())
ON CONFLICT (id) DO NOTHING;

-- Mark all seed profiles as onboarding completed
...
-- ============================================
-- 12. NOTIFICATIONS (manual seed, triggers disabled)
-- ============================================
