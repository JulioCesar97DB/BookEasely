-- ============================================
-- Notification Triggers V2: SMS + Push via Edge Functions
-- ============================================
-- Updates handle_booking_notification() and handle_review_notification()
-- to call the notify Edge Function via pg_net after in-app notifications.
--
-- Required database settings (set in Supabase dashboard → SQL Editor):
--   ALTER DATABASE postgres SET app.settings.supabase_url = 'https://<ref>.supabase.co';
--   ALTER DATABASE postgres SET app.settings.service_role_key = '<service-role-key>';

-- ============================================
-- BOOKING NOTIFICATION TRIGGER (v2)
-- ============================================
...
BEGIN
  ...
  -- Edge Function URL
  v_url := current_setting('app.settings.supabase_url', true) || '/functions/v1/notify';
...
-- ============================================
-- REVIEW NOTIFICATION TRIGGER (v2)
-- ============================================
...
-- ============================================
-- Runs every day at 8 AM UTC. Calls the daily-reminders Edge Function
-- which sends SMS reminders to clients and push digest to workers.
--
-- NOTE: pg_cron must be enabled in Supabase dashboard (Database → Extensions).
-- The cron job calls the Edge Function via pg_net.
